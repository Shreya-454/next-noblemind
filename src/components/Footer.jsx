...
const Footer = () => {
  ...
  return (
    <div className=' bg-foot pt-20 md:pt-[138px] bg-cover bg-center bg-no-repeat pb-5 md:pb-[35px]'>
...
<a href="#">
<Image src="/assets/images/footlogo.webp" alt="logo" width={241.94} height={42}/></a>
