...
const Contact = () => {
  ...
  return (
    <div className="lg:pt-[150px] md:pt-20 pt-10">
      <div
        className="container max-w-[1140px] 2xl:max-w-[1320px] mx-auto px-3 w-full"
        id="contact"
      >
        <div className="flex lg:flex-row flex-wrap -mx-3 flex-col-reverse">
          <div className="lg:w-1/2 px-3" data-aos="zoom-in">
            ...
            <form
              className="max-w-[478px] mt-[18px] mx-auto lg:mx-0"
              ...
              <div className="flex w-full gap-[11px] mb-3 md:mb-4">
                <div className="w-1/2">
                  ...
                  {formErrors.firstname && (
                    <p className="text-[red] pt-1 font-exo">
                      {formErrors.firstname}
                    </p>
                  )}
                </div>
              ...
              {showSuccessPopup && (
                <div>
                  <div className="flex flex-col items-center">
                    <p className="text-black pt-1 font-outfit">
                      Form submitted successfully!
                    </p>
                    <button
                      className=" bg-btn-gradient text-white px-3 py-2 font-outfit"
          ...
          <div
            className="lg:w-1/2 px-3 flex justify-center"
            data-aos="fade-left"
          >
            <Image
