...
const Faq = () => {
  ...
  return (
    <div className=' lg:pt-[150px] md:pt-20 pt-10 relative' id='faq'>
        <Image src="/assets/images/triangle.webp" width={70.97} height={95.49} alt="tri"  className='absolute top-[11%] left-[3%] hidden lg:block '/>
        <Image src="/assets/images/triangle.webp" width={70.97} height={95.49} alt="tri"  className='absolute bottom-[25%] right-[3%] hidden lg:block'/>
