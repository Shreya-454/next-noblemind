...
const Choose = () => {
  return (
    <div className='lg:pt-[151px] md:pt-20 pt-10 relative z-[1]' id='choose'>
         <Image src="/assets/images/triangle.webp" width={70.97} height={95.49} alt="tri" className=' absolute top-[15%] left-[3%] hidden lg:block' />
         <Image src="/assets/images/triangle.webp" width={70.97} height={95.49} alt="tri" className=' absolute right-[1%] bottom-0 hidden lg:block z-[-1]' />
      <div className="container 2xl:max-w-[1320px] max-w-[1140px] mx-auto px-3">
      <Image src="/assets/images/chooseimg.webp"  alt='img' height={527} width={1140} className='lg:h-[527px] w-full md:mt-8 mt-0 block lg:hidden' data-aos="zoom-in"/>
...
<Swiper
    ...
    <Image src="/assets/images/chooseimg.webp"  alt='img' height={527} width={1140} className='lg:h-[527px] w-full md:mt-8 mt-0 hidden lg:block' data-aos="zoom-in"/>
    </div>
    </div>
  )
}
