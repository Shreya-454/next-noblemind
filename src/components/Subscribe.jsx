  ...
  return (
    <div className="lg:pt-[64px] relative  " id="subs">
      ...
      <div className="container max-w-[1140px] 2xl:max-w-[1320px] mx-auto px-3">
        <div className=" bg-cover bg-subs bg-center bg-no-repeat w-full rounded-xl py-10 md:py-[60px] flex flex-col items-center md:!translate-y-[86px] !translate-y-10 px-4 " data-aos="zoom-in-down">
